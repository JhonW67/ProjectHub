...
const Auth = () => {
  ...
  // Redirect to login if invalid type
          ...
          <div className="text-center text-white p-8">
            ...
            <div className="mt-12 p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              <p className="text-lg font-medium mb-3">
                {type === 'login' ? 'Faça parte da comunidade acadêmica' : 
                 type === 'register' ? 'Junte-se à nossa comunidade' : 
                 'Área restrita para administradores'}
              </p>
              <p className="text-sm">
                {type === 'login' ? 'O ProjectHub permite que alunos e professores colaborem nos projetos extensionistas do UNIVAG, promovendo a inovação e o aprendizado prático.' : 
                 type === 'register' ? 'Crie sua conta para acessar todas as funcionalidades do ProjectHub e começar a trabalhar em projetos inovadores.' : 
